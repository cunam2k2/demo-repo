...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder>{
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position) {
        ...
        if (note.getReminderTime() > 0) {
            holder.textView_reminderTime.setVisibility(View.VISIBLE);
            holder.textView_reminderTime.setText(DateTimeUtils.formatReminderTime(note.getReminderTime()));
        } else {
            holder.textView_reminderTime.setVisibility(View.GONE);
        }
...
class NotesViewHolder extends RecyclerView.ViewHolder{
    ...
    TextView textView_title, textView_notes, textView_date,textView_reminderTime;
    ...
    public NotesViewHolder(@NonNull View itemView) {
        ...
        textView_reminderTime = itemView.findViewById(R.id.textView_reminderTime);
